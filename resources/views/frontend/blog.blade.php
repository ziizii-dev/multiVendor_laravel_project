                ...
                <div class="col-lg-8">
                    ...
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="blog-details.html"><img style="width:400px; height:400px" src="{{asset('upload/blog/'.$item->blog_image)}} " alt=""></a>
                            ...
                            <ul class="rc__post">
                                ...
                                <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="blog-details.html"><img style="width:80px; height:100px" src="{{asset('upload/blog/'.$all->blog_image)}} " alt=""></a>
                                    </div>
                                    <div class="rc__post__content">
                                        <h5 class="title"><a href="{{route('details#blog',$all->id)}} ">{{$all->blog_title}} </a></h5>
