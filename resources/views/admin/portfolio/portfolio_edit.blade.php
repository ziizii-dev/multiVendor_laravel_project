            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <h3 class="text-center title-2">Portfolio Edit Page</h3>
                    </div>
                    <hr>
                        ...
                        <div class="row">
                            <div class="col-4 offset-1">
                                    ...
                                    <div>
                                        ...
                                        src="{{asset('upload/portfolio/'.$portfolio->portfolio_image)}} " />
                                    </div>
                                    <div class="mt-3">
                                    ...
                                    <div class="mt-3">
                                      <button class="btn btn-primary form-control text-white" type="submit">Update Portfolio Page</button>
                                    </div>
                            ...
                            <div class=" col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-pament" name="portfolio_name" type="text" value=" {{$portfolio->portfolio_name}} "  class="form-control @error('portfolio_name') is-invalid
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="cc-pament" name="portfolio_title" type="text" value="{{$portfolio->portfolio_title}} "  class="form-control @error('portfolio_title') is-invalid
