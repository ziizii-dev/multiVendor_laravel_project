            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <h3 class="text-center title-2">Edit Blog Page</h3>
                    </div>
                    <hr>
                        ...
                        <div class="row">
                            <div class="col-4 offset-1">
                                    ...
                                    <div>
                                        ...
                                        src="{{asset('upload/blog/'.$blogs->blog_image)}} " />
                                    </div>
                                    <div class="mt-3">
                                    ...
                                    <div class="mt-3">
                                      <button class="btn btn-primary form-control text-white" type="submit">Update Blog Page</button>
                                    </div>
                            </div>
                            <div class=" col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="cc-pament" name="blog_title" type="text" value="{{$blogs->blog_title}} "  class="form-control @error('blog_title') is-invalid
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="cc-pament" name="blog_tags" type="text" value="{{$blogs->blog_tags}} "  class="form-control @error('blog_tags') is-invalid
