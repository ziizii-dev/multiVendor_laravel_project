            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <h3 class="text-center title-2">Update Multi Image Page</h3>
                    </div>
                    <hr>
                            ...
                            <div class="col-3 offset-3">
                                    ...
                                    <div class=" col-sm-10">
                                        <img style="width:220px; height:220px" class="card-img-top img-fluid" id="showImage"
                                         src="{{asset('upload/multi/'.$multiImage->multi_image)}} " />
                                    </div>
                                    <div class="mt-3">
                                        <input type="file" name="multi_image" id="image" class="form-control @error('about_image') is-invalid @enderror" >
                                        @error('multi_image')
                                    ...
                                    <div class="mt-3">
                                      <button class="btn btn-primary form-control text-white" type="submit">Update Multi Image</button>
                                    </div>
